...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $2}')
ipsaya=$(wget -qO- ifconfig.me)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/contrabrand/reg/main/permission"
checking_sc() {
...
clear
LIST=$(curl -sS https://raw.githubusercontent.comoktaviaps/license/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.comoktaviaps/license/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.comoktaviaps/license/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.comoktaviaps/license/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.comoktaviaps/license/main/key | grep $kode | awk '{print $6}')
U2=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $6}')
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.comoktaviaps/license/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
madmin=$(curl -sS https://raw.githubusercontent.com/contrabrand/reg/main/permission | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
clear;clear;clear
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│${NC} ${COLBG1}                  ${WH} • JAVA TUNNELING •                   ${NC} $COLOR1│ $NC"
echo -e " $COLOR1╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭══════════════════════════════════════════════════════════╮${NC}"
